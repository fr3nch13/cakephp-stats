 ...
 * Initial Update UIDs
 */
class SisStatsUpdateUIDs extends AbstractMigration
{
    /**
     * Create the tables.
     *
    ...
    public function up(): void
    {
        ...
        $this->table('stats_entities')->changeColumn('id', 'integer', ['limit' => 50, 'identity' => true])->update();

        $io->out(__('Updating UID for Table: {0}', ['stats_counts']));
        $this->table('stats_counts')->changeColumn('id', 'integer', ['limit' => 50, 'identity' => true])->update();
